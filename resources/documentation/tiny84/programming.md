...
You can use the AVRISP mkII to upload and program your code, like this:
 ...
 1. Use "**`Settings->Programmer`**" to open the Programmer dialog and select the **`AVRISP mkII`** option.
 ...
 6. Select "**`Actions->Program Flash and Fuse(s)`**" to upload and program the code and update the fuse settings into the ATtiny84.
